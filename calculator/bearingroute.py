...
def beamd_cal():
    ...
    if form.validate_on_submit():
        ...
        if form.loadnum.data:
            ...
            NL = 0
        d = Infoform(
            beamlength=form.beamlength.data,
            supportnum=form.supportnum.data,
...
def beamd_supp():
    ...
    if form1.validate_on_submit():
        lst[0] = [
            form1.supportloc.data,
            form1.supporttype.data,
            form1.supportdirec.data,
        ]

    e = Dtform(
        supportloc=form1.supportloc.data,
        supporttype=form1.supporttype.data,
        supportdirec=form1.supportdirec.data,
        loadloc=form1.loadloc.data,
        loadtype=form1.loadtype.data,
        loaddirec=form1.loaddirec.data,
        loadvalue=form1.loadvalue.data,
    )
    db.session.add(e)
    db.session.commit()
    dt = Dtform.query.all()
